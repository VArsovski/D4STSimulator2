...
namespace D4ST_Api.Models.StatCalculators
{
    public class SkillAffixProcStat : ISkillAffixProcStat
    {
        ...
        public SkillAffixProcStat(decimal procChance, PowerTypesEnum powerType, string selectedAffix, DamageSkillStat skillData, List<AffixMetadataEnum> md)
        {
            ...
            var selectedPower = powerType == PowerTypesEnum.AngelicPower ? skillData.AngelicPower
                            :   powerType == PowerTypesEnum.DemonicPower ? skillData.DemonicPower
                            :   skillData.AncestralPower;

            this.Level = selectedPower;
            ...
            var spender = md.Contains(AffixMetadataEnum.HighCost_Spender);
            ...
            var randDurBonus = rand.Next(minBuffDurIncr, maxBuffDurIncr) * selectedPower;
            ...
            var randBonus = rand.Next(minDPSIncr, maxDPSIncr) * selectedPower;
            ...
            {
                var durIncr = highTier ? rand.Next(selectedPower * 25, selectedPower * 45) : rand.Next(selectedPower * 15, selectedPower * 25);
                this.Duration = skillData.Duration * (1 + durIncr/100);
                this.ProcAmount = DecimalHelper.RoundToDecimalsD(average * randBonus/100, 2);
            }

            // TODO: Set procChance upgrades per level, i.e. selectedPower
