...
{
    public class StaminaReturnHitProc : IHitProcAffix
    {
        ...
        public SelfEmpowerHitProc CalculateProcAmount(IClassDefinition classInfo) {
            var baseProcRate = DecimalHelper.RoundToDecimals((classInfo.ClassType == Enums.ClassTypeEnum.Melee ? 10 : 6)/100, 3);
            var bonusProcRate = DecimalHelper.RoundToDecimals(0.66*classInfo.DemonicPower * (classInfo.ClassType == Enums.ClassTypeEnum.Melee ? 0.6 : 0.5), 3);
