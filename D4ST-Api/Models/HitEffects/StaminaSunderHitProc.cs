...
namespace D4ST_Api.Models.HitEffects
{
    public class StaminaSunderHitProc : IHitProcAffix
    {
        ...
        public SelfEmpowerHitProc CalculateProcAmount(IClassDefinition classInfo) {
            var baseProcRate = DecimalHelper.RoundToDecimals((classInfo.ClassType == Enums.ClassTypeEnum.Melee ? 10 : 5)/100, 3);
            var bonusProcRate = DecimalHelper.RoundToDecimals(0.66*classInfo.AncestralPower * (classInfo.ClassType == Enums.ClassTypeEnum.Melee ? 0.6 : 0.5), 3);
